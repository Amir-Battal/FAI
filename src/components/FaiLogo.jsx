  ...
  return (
    <div className="w-full z-99">
      <svg className="[mix-blend-mode:difference]" id="Layer_2" width={50} xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 645.97 1652.49">
        ...
        <path fill={color} d="M585.88,862.21v229.73c0,149.35-121.06,270.41-270.41,270.41-149.32,0-270.41-121.06-270.41-270.41v-229.73c2.47,0,4.96-.03,7.43-.03.1,75.45,63.24,135.81,135.91,133.39,69.48-2.31,127.04-61.31,127.07-133.37h270.41Z"/>
      </svg>
    </div>
  );
};

export default FaiLogo;
